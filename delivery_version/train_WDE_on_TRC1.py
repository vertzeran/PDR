...
from delivery_version.utils.Functions import PrepareInputForResnet18
...
def train_on_SBG_data(root_dir, comment, epochs=300, batch_size=1024, lr=0.0005, mode=None,
    ...
    description = 'optimization results on ' + mode + ', window size: ' + str(train_ds.window_size) + comment
    print(description)
        ...
        for i, data in enumerate(train_dl, 0):
            ...
            with torch.no_grad():
                ...
                if (Sim < Min_loss):
                    ...
                    min_name = 'WDE_regressor_' + mode + '_' + data_type + '_' + str(round(Sim,3)) + '.pth'
...
if __name__ == '__main__':
    root_dir = '/home/maint/git/walking_direction_estimation/data/XY_pairs/2023-01-22T19:51:40.411866TRC#1 swing wind_size 200swing left right mix'
    comment = 'swing left right mix'
    outputfolder, min_name = train_on_SBG_data(root_dir, comment)