...
from delivery_version.utils.Classes import RidiExp, SbgExpRawData
from delivery_version.AAE.AAE import AtitudeEstimator
...
def CalcResultsOnFile(file_path, dataset, override, GT=None):
    ...
    if exists(possible_result_file) and override=='False':
    ...
    if len(AHRS_results_files) == 0 or override == 'True':
