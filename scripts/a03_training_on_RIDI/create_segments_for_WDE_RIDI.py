...
def get_tain_test_dir(mode):
    if mode == 'text':
        ...
        train_dir = '/data/Datasets/Navigation/RIDI_dataset_train_test/RIDI_mixed_train'
        test_dir = '/data/Datasets/Navigation/RIDI_dataset_train_test/RIDI_mixed_test'
    else:
        raise 'invalide mode'
...
def create_segments(comment, window_size=200, mode=None, add_quat=False, heading_fix=False, traj_length_limit=None,
    ...
    info_dict['heading_fix'] = heading_fix
    ...
    X_train, Y1_train, Y2_train = get_xy_pairs(window_size, train_segments_for_WDE,
                                               add_quat=add_quat, heading_angle_fix=heading_fix)
