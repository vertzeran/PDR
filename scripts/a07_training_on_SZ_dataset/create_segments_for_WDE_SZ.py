...
def create_segments(params):
    ...
    now = now.replace(":", "_")
    description = params["dataset"] + ' ' + params["mode"] + ' ' + 'wind_size ' + str(params["window_size"]) + params["comment"]
    print(description)
    ...
    train_dir, test_dir = get_tain_test_dir(mode=params["mode"])
    ...
    segments_train, AHRS_results_segments_list_train = \
        get_segments_from_exp_list_SZ(exp_list=exp_list_train,
                                      params=params,
                                      shuffle=False,
                                      use_GT_att=False,
                                      logger=logger)
    ...
    segments_test, AHRS_results_segments_list_test = \
        get_segments_from_exp_list_SZ(exp_list=exp_list_test,
                                      params=params,
                                      shuffle=False,
                                      use_GT_att=False,
                                      logger=logger
