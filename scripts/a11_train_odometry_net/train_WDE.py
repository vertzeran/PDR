...
def train(params):
    ...
    description = 'WDE_optimization_' + params["comment"]
    print(description)
        ...
        for i, data in enumerate(train_dl, 0):
            ...
            with torch.no_grad():
                ...
                if (Sim < Min_loss):
                    ...
                    min_name = 'WDE_regressor_' + str(round(Sim,3)) + '.pth'
...
if __name__ == '__main__':
    ...
    params["data_folder"] = '/home/maint/git/walking_direction_estimation/data/XY_pairs/2023-03-23T12_39_34.904839dL_cal_method'
