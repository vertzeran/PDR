...
from scripts.a05_train_on_TRC_1.create_segments_for_WDE_SBG import get_segments_from_exp, get_dir_to_analyze, get_exp_list, rotate_traj_to_minimize_error
# from scripts.create_segments_for_WDE_SBG import get_segments_from_exp as get_segments_from_exp_SBG
# from scripts.create_segments_for_WDE_RIDI import get_segments_from_exp as get_segments_from_exp_RIDI
import torch
import json
...
def test_on_exp(window_size=200, wind_size_for_heading_init=1000, WD_est_method = 'compare_all_methods',
                ...
                pdr_net=None, add_quat=False, dataset='TRC#1'):
...
def test_on_list(exp_list, info, traj_folder, res18model, add_quat, dataset):
    file_names = []
    PCA_tarj_errors = []
    PCA_tarj_lengths = []
    PCA_errors = []
