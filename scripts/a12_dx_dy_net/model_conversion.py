...
if __name__ == '__main__':
    window_size = 250
    add_quat = True
    input_sizes = (1, 3, window_size, 1)
    if add_quat:
        input_size = (1, 7, window_size, 1)
    device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu')
    input_tensor = torch.randn(input_size).to(device)
    root_dir = "/home/maint/git/walking_direction_estimation/data/optimization_results/2023-03-16T14:49:12.177262optimization results on RIDI & SZ combined"
    file_name = 'WDE_regressor__0.28.pth'
