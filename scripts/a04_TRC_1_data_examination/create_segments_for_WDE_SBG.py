...
def create_segments(comment, window_size=200, mode=None, add_quat=False, heading_fix=False, traj_length_limit=None,
    ...
    exp_list_train = get_exp_list(list_of_train_persons, dir_to_analyze)
    exp_list_test = get_exp_list(list_of_test_persons, dir_to_analyze)
    # sample experiment list just for running fast and developing this script
    if sample_percentage is not None:
        num_of_idx_to_sample = round(len(list_of_train_persons) * sample_percentage / 100)
        ...
        num_of_idx_to_sample = round(len(list_of_test_persons) * sample_percentage / 100)
        num_of_idx_to_sample = 1
    ...
    segments_train, AHRS_results_segments_list_train = \
        get_segments_from_person_list_SBG(person_list=list_of_train_persons,
                                          ...
                                          wind_size_for_heading_init=wind_size_for_heading_init,
                                          logger=logger, calc_heading_fix=heading_fix,
...
if __name__ == '__main__':
    outputfolder = create_segments(comment='test ', window_size=200, mode='swing')
